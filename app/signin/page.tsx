    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#f4faf7] px-4 py-12">
        <div className="w-full max-w-md">
          ...
          {/* Card */}
          <div className="rounded-2xl bg-white p-7 sm:p-9 shadow-lg shadow-teal-500/5 ring-1 ring-gray-100">
            ...
            <form className="mt-7 space-y-5">
              ...
              <Button
                type="submit"
                className="w-full h-11 rounded-lg bg-teal-600 text-white hover:bg-teal-700 text-base font-semibold"
                size="lg"
              >
                Sign In
              </Button>
