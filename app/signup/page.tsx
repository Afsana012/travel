...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Right — Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#f4faf7] px-4 py-12">
        <div className="w-full max-w-md">
          ...
          {/* Card */}
          <div className="rounded-2xl bg-white p-7 sm:p-9 shadow-lg shadow-emerald-500/5 ring-1 ring-gray-100">
            ...
            <form className="mt-7 space-y-5">
              ...
              <Button
                type="submit"
                className="w-full h-11 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700 text-base font-semibold"
                size="lg"
              >
                Create Account
              </Button>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 h-11 rounded-lg border border-gray-200 text-sm font-medium text-slate-700 hover:bg-gray-50 transition">
