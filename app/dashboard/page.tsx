  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
        ...
        <Button className="bg-slate-800 hover:bg-slate-700 gap-2 shrink-0">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="rounded-xl bg-white p-5 ring-1 ring-gray-100"
          >
            <div className="flex items-center justify-between">
              ...
              <div className={`rounded-lg p-2 ${stat.bg}`}>
                <stat.icon className={`size-4 ${stat.color}`} strokeWidth={2} />
              </div>
            </div>
      ...
      <div className="flex gap-6">
        ...
        >
          ...
          Filters
          <ChevronDown
            className={`size-3.5 transition ${showFilters ? "rotate-180" : ""}`}
          />
        </button>
        ...
        >
          <div className="rounded-xl bg-white p-5 ring-1 ring-gray-100 space-y-5 sticky top-6">
            <div className="flex items-center justify-between">
              ...
              >
                ...
                <div className="p-4 space-y-2">
                  <div className="flex items-start justify-between">
                    ...
                    <span className={`text-xs font-semibold ${dest.tagColor}`}>
                      {dest.tag}
                    </span>
                  </div>
